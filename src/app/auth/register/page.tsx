...
import {
  ...
  Eye, EyeOff, ChevronRight, AlertCircle, Mail
} from "lucide-react";
...
export default function RegisterPage() {
  ...
  return (
    <>
      <Navbar />
      <main
        className="flex-1 min-h-screen flex items-center justify-center px-4 py-8"
        style={{
          background:
            "radial-gradient(ellipse at 30% -10%, rgba(37,99,235,0.10) 0%, transparent 60%), " +
            "radial-gradient(ellipse at 70% 50%, rgba(14,165,233,0.05) 0%, transparent 50%), #f8fafc",
        }}
      >
        <div className="w-full max-w-md">
          <div className="relative">
            <div className="absolute -top-16 -right-20 w-48 h-48 rounded-full bg-[#14b8a6]/10 blur-3xl pointer-events-none" />
            <div className="absolute -bottom-16 -left-20 w-40 h-40 rounded-full bg-[#2563eb]/10 blur-3xl pointer-events-none" />
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-white border border-[rgba(37,99,235,0.08)] text-sm text-[#1e293b] placeholder-[rgba(0,0,0,0.3)] focus:border-[#2563eb] focus:ring-1 focus:ring-[#2563eb]/20 focus:outline-none transition-all"
                      required
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="至少6位密码"
                      className="w-full pl-10 pr-10 py-2.5 rounded-xl bg-white border border-[rgba(37,99,235,0.08)] text-sm text-[#1e293b] placeholder-[rgba(0,0,0,0.3)] focus:border-[#2563eb] focus:ring-1 focus:ring-[#2563eb]/20 focus:outline-none transition-all"
                      required
                      minLength={6}
