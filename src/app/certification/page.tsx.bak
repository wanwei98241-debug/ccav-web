    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-4 py-12 relative z-10">
        ...
        <section className="mb-16">
          <h2 className="text-2xl serif font-bold text-white mb-6">三级认证体系</h2>
                ...
                <div className="flex flex-col md:flex-row items-start gap-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <span className="text-lg font-bold text-white">第{item.level}级</span>
                      <span className="text-[10px] text-[#c8b898] bg-[#c8b898]/10 px-2 py-0.5 rounded-full border border-[#c8b898]/20">{item.target}</span>
                    </div>
        ...
        {/* 认证流程 */}
        <section className="mb-16">
          <h2 className="text-2xl serif font-bold text-white mb-6">认证流程</h2>
          <div className="flex flex-wrap items-center justify-center gap-2">
            {["报名申请", "资格审核", "理论考试", "实操考核", "作品评审", "证书发放"].map((step, j) => (
              <div key={j} className="flex items-center gap-2">
                <div className="ink-card px-5 py-3 text-sm text-white/50">{step}</div>
        ...
        {/* 证书体系 */}
        <section className="mb-16">
          <h2 className="text-2xl serif font-bold text-white mb-6">证书体系</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div key={i} className="ink-card p-5 text-center">
                ...
                <h3 className="text-sm font-bold text-white mb-2">{item.cert}</h3>
                <p className="text-xs text-white/30">{item.for}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="text-center mb-16">
          <div className="ink-card p-8 md:p-12">
            <h2 className="text-2xl serif font-bold text-white mb-4">开始认证</h2>
            <p className="text-white/40 mb-6">认证报名、证书查询、合作考点申请，请与我们联系。</p>
        ...
        <section id="cert-search" className="mb-16">
          <div className="ink-card p-6 md:p-8 text-center">
            <h2 className="text-xl serif font-bold text-white mb-4">证书查询</h2>
            <p className="text-white/30 text-sm mb-6">输入证书编号或姓名，查询证书信息（查询系统开发中，敬请期待）</p>
            <div className="max-w-md mx-auto">
              ...
              <p className="text-[10px] text-white/20 mt-2">查询功能即将上线</p>
            </div>
          </div>
        </section>
      </main>
