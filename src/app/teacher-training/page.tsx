    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-4 py-12 relative z-10">
        ...
        <section id="details" className="mb-16">
          <h2 className="text-2xl serif font-bold text-[#1e293b] mb-6">培训对象</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className="ink-card p-6">
                ...
                <p className="text-[rgba(0,0,0,0.5)] text-sm">{item.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mb-16">
          <h2 className="text-2xl serif font-bold text-[#1e293b] mb-6">培训内容</h2>
        ...
        {/* 培训形式 */}
        <section className="mb-16">
          <h2 className="text-2xl serif font-bold text-[#1e293b] mb-6">培训形式</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="ink-card p-6">
              <div className="text-lg font-bold text-[#1e293b] mb-2">📘 3天基础班</div>
              <p className="text-[rgba(0,0,0,0.5)] text-sm mb-4">覆盖AI视频核心技能与教学法，适合有教学基础的老师快速上手</p>
              <div className="flex flex-wrap gap-2 text-xs text-[rgba(0,0,0,0.45)]">
                <span className="bg-[rgba(37,99,235,0.08)] px-2 py-1 rounded">¥2,980</span>
                <span className="bg-[rgba(37,99,235,0.08)] px-2 py-1 rounded">含教材</span>
                <span className="bg-[rgba(37,99,235,0.08)] px-2 py-1 rounded">含工具额度</span>
                <span className="bg-[rgba(37,99,235,0.08)] px-2 py-1 rounded">结业证书</span>
              </div>
            </div>
            <div className="ink-card p-6">
              <div className="text-lg font-bold text-[#1e293b] mb-2">📗 5天深度班</div>
              <p className="text-[rgba(0,0,0,0.5)] text-sm mb-4">全面掌握AI视频教学体系与项目管理，适合希望成为认证讲师的教师</p>
              <div className="flex flex-wrap gap-2 text-xs text-[rgba(0,0,0,0.45)]">
                <span className="bg-[rgba(37,99,235,0.08)] px-2 py-1 rounded">¥4,980</span>
                <span className="bg-[rgba(37,99,235,0.08)] px-2 py-1 rounded">含教材+教辅</span>
                <span className="bg-[rgba(37,99,235,0.08)] px-2 py-1 rounded">含工具额度</span>
                <span className="bg-[rgba(37,99,235,0.08)] px-2 py-1 rounded">认证讲师资格</span>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* 培训成果 */}
        <section className="mb-16">
          <h2 className="text-2xl serif font-bold text-[#1e293b] mb-6">培训成果</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className="ink-card p-6 text-center">
                ...
                <p className="text-[rgba(0,0,0,0.5)] text-xs">{item.desc}</p>
              </div>
            ))}
          </div>
        </section>
