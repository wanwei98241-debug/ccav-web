    ...
    return (
      <>
        ...
        <main className="flex-1 pt-32 text-center min-h-[60vh]">
          <h1 className="text-2xl text-[#f0f6fc]">模块不存在</h1>
    ...
    <>
      ...
      <main className="flex-1 pt-16">
        ...
        <section className="py-12 bg-[#0d1117]">
          <div className="max-w-4xl mx-auto px-5">
            {/* Module Overview */}
            <div className="p-6 rounded-2xl bg-[#161b22] border border-[#30363d] mb-8">
              <h2 className="text-xl font-semibold text-[#f0f6fc] mb-4">📋 模块概览</h2>
              <div className="flex flex-wrap gap-3 text-sm">
                <span className="px-3 py-2 rounded-lg bg-[#0d1117] border border-[#30363d] text-[#c9d1d9]">
                  所属课程：{course.title}
                </span>
                <span className="px-3 py-2 rounded-lg bg-[#0d1117] border border-[#30363d] text-[#c9d1d9]">
            ...
            <div className="space-y-6">
              <h2 className="text-xl font-semibold text-[#f0f6fc]">📖 课程内容</h2>
              {mod2.content.map((lesson, i) => {
                ...
                return (
                  ...
                  >
                    <div className="p-5 rounded-xl bg-[#161b22] border border-[#30363d] hover:border-[#58a6ff]/50 hover:bg-[#1a2332] transition-all cursor-pointer">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-2">
                            <h3 className="font-semibold text-[#f0f6fc] group-hover:text-[#58a6ff] transition-colors">{cleanTitle}</h3>
                            {isPractical && (
                          ...
                          {hasDetail && mod2.lessons![i].summary && (
                            <p className="text-xs text-[#8b949e] line-clamp-2 mb-2">{mod2.lessons![i].summary}</p>
                          )}
                          <div className="mt-2 p-3 rounded-lg bg-[#0d1117] border border-[#30363d] flex items-center justify-center h-10 text-xs text-[#8b949e]">
                            <Play className="w-3 h-3 mr-1 text-[#484f58]" />
                            视频（即将上线）
                          </div>
                        </div>
                      </div>
            ...
            <div className="mt-8 p-6 rounded-2xl bg-[#161b22] border border-[#30363d]">
              <h2 className="text-xl font-semibold text-[#f0f6fc] mb-4">✅ 学习检查点</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {mod2.content.map((lesson, i) => (
                  <div key={i} className="flex items-center gap-3 text-[#c9d1d9]">
                    <div className="w-6 h-6 rounded-full border-2 border-[#30363d] flex items-center justify-center shrink-0">
                      <span className="text-xs text-[#484f58]">{i + 1}</span>
                    </div>
            ...
            <div className="mt-10 flex items-center justify-between">
              {prevModule ? (
                <Link
                  href={prevModule}
                  className="flex items-center gap-2 px-5 py-3 rounded-xl bg-[#161b22] border border-[#30363d] text-[#c9d1d9] hover:border-[#58a6ff]/50 hover:text-[#58a6ff] transition-all"
                >
